...
export class Summary implements OnInit {
  ...
  ngOnInit(): void {
    ...
    const totalCost: number = this.summaryDetails.flight.price * this.summaryDetails.travelers + this.summaryDetails.hotel.price * this.summaryDetails.rooms * days;

    const priceSummary: Partial<BookingDetails> = {
      totalCost
    }
    this.bookingService.updateBookingDetails(priceSummary);
    this.summaryDetails = this.bookingService.getBookingDetails();
  }
